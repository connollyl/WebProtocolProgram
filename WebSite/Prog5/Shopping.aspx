<%@ Page Title="" Language="C#" MasterPageFile="~/Prog5/Prog5MasterPage.master" AutoEventWireup="true" CodeBehind="Shopping.aspx.cs" Inherits="WebSite.Prog5.Shopping" %>
<asp:Content ID="Content1" ContentPlaceHolderID="PageContentPlaceHolder" runat="server">
    <table class="auto-style10">
        ...
        <tr>
            <td class="auto-style6">
                <asp:SqlDataSource ID="SDSServer" runat="server" ConnectionString="<%$ ConnectionStrings:UWPCS3870ConnectionStringServer %>" SelectCommand="SELECT * FROM [Product]"></asp:SqlDataSource>
            </td>
            <td class="auto-style5">
                &nbsp;</td>
            <td class="auto-style5">
